            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        Due
                        <br />
                        <input id="wd-due-date" type="date" value="2025-02-13" />
                        <br />
                        <br />
                    </td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td><input id="wd-available-from" type="date" value="2025-02-06" /></td>
                    <td><input id="wd-available-until" type="date" value="2025-02-20" /></td>
                </tr>
                <br />
                <tr>
                    <td></td>
